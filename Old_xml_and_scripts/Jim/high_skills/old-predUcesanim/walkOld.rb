...
class WalkOld < RubyHighSkill
  ...
  def pickLowSkill
    ...
    return get_skill("walk_fine_fast2_optimized2") if straight?(target_position)
    #return get_skill("turnleft90") if back_and_left?(target_position)
    #return get_skill("turnright90") if back_and_right?(target_position)
    #return get_skill("stepleft1") if left_and_close?(target_position)
    #puts '4'
    #return get_skill("stepright1") if right_and_close?(target_position)
    #puts '5'
